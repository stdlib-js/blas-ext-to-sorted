...
```javascript
import toSorted from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-to-sorted@esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-to-sorted@esm/index.mjs';
```
